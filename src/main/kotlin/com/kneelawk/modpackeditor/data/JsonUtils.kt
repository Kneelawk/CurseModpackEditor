...
/**
 * Gets a [Double] associated with [key] and throws a [JsonParseException] if it is missing or `null`.
 */
fun JsonObject.reqDouble(vararg key: String): Double {
    return double(*key) ?: jsonNull(*key)
}
